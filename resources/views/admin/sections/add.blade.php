                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade @if($locale == app()->getLocale()) active show @endif " id="locale-{{ $locale }}">
                        ...
                        <div class="form-group">
                            ...
                            @enderror
                            <input type="text" name="{{ $locale }}[title]" onchange="myFunction()" parsley-trigger="change" class="@error('title') danger @enderror form-control" id="{{ $locale }}-title" Required>
                        </div>
...
{{-- <script>
    function validateTabs() {
      ...
      // Loop through each tab and check for errors
      var hasErrors = false;
      $('#tab').each(function() {
        var tab = $(this);
        ...
        // Add or remove active class based on errors
        if (tabHasErrors) {
          tab.addClass('has-errors');
        } else {
          tab.removeClass('has-errors');
        }
      });
    
      // Show the error tab if there are any errors
      if (hasErrors) {
        $('#error-tab').addClass('active');
      } else {
        $('#error-tab').removeClass('active');
      }
    }
    </script> --}}
